...
class textReader():
    ...
    def _stop_words(self):
        self._stopWords = {'esto','esta','e','ello','les','da','ha','sus','donde','este','la','del','toda','sea','cómo','puede','muy','estos','su','esto','sín','sin','o','para','también', 'casi', 'través', 'solo', 'que', 'durante', 'un', 'vez', 'qué', 'entre', 'como', 'allí', 'cualquiera', 'y', 'han', 'por', 'las', 'pero', 'podría', 'cada', 'siempre', 'al', 'la', 'haga', 'están', 'después', 'cualquier', 'acerca', 'sin', 'incluso', 'más', 'según', 'los', 'son', 'hay', 'otro', 'a', 'todo', 'de', 'allá', 'ya', 'abajo', 'contra', 'se', 'ambos', 'una', 'mucho', 'alrededor', 'detrás', 'con', 'el', 'excepto', 'poco', 'si', 'misma', 'etc', 'antes', 'arriba', 'lo', 'ser', 'hacer', 'fueron', 'porque', 'aunque', 'menos', 'es', 'además', 'no', 'en', 'antemano'}
